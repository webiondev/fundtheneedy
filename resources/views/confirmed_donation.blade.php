           ...
           action="{{url('confirmingdonation')}}" enctype="multipart/form-data">
                      ...
                      @elseif($data[0]->medium =='goods')
                        <div class="form-group{{ $errors->has('quantity') ? ' has-error' : '' }}">
                            <div class="form-group">
                         <input type="text" id="quantity" name ="quantity" class="form-control  form-control-sm" placeholder="quantity donated" required="">
                      ...
                      @endif
                       ...
                       <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                        ...
                        <input type="date" id="ddate" name ="date" class="form-control" data-toggle="tooltip" data-placement="top" title="donated on" required="">
                         @if ($errors->has('date'))
                                    <span class="help-block">
                        ...
                        <input type="file" id="file" name ="file" class="form-control"  data-toggle="tooltip" data-placement="top" title="upload a photo of proof" required>
                         @if ($errors->has('file'))
                                    <span class="help-block">
