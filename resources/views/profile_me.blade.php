@extends('layouts.index')
    ...
    <div class="container">
        <h3 class="site-title">{{__('global.your_profile')}}</h3>
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                 <div class="panel">
            ...
            <form class="m-t" id="fn-form" method="POST" action="{{ route('editprofilepic') }}" enctype="multipart/form-data">
                        ...
                        <input type="file" id="file" name ="file">
                         @if ($errors->has('file'))
                          ...
                          <button type="submit" class="btn btn-primary block full-width m-b">{{__('global.upload')}}</button>
                ...
                <form class="m-t" id="fn-form" method="POST" action="{{ route('editprofile') }}" enctype="multipart/form-data">
                    ...
                    <input type="text" name ="name" value="{{auth()->user()->name}}" class="form-control" placeholder="{{__('global.name')}}" required="">
                         @if ($errors->has('name'))
                                    <span class="help-block">
                        ...
                        <input type="email" name ="email" class="form-control" placeholder="{{__('global.email')}}" value="{{auth()->user()->email}}" >
                         @if ($errors->has('email'))
                                    <span class="help-block">
                        ...
                        <input type="password" name ="password" class="form-control" placeholder="{{__('global.password')}}" required="">
                         @if ($errors->has('password'))
                           ...
                           <div class="form-group">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="{{__('global.confirm_password')}}" >
                         </div>
                 ...
                 <select class="form-control dropdown" id="occupation" name="occupation">
                    ...
                    <optgroup label="Other Occupations:">
                      ...
                      <!-- Upload image of user -->
                        ...
                        <button type="submit" class="btn btn-primary block full-width m-b">{{__('global.submit_edit')}}</button>


                    </form>

                      <button type="button"  class="btn btn-primary block full-width m-b" id="deleteBtn">{{__('global.delete')}}</button>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">{{__('global.deleting_account')}}</h4>
                                        </div>
                                        <div class="modal-body">
                                            <p>{{__('global.are_your_sure')}}</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" onclick="deleteThis()" data-dismiss="modal">{{__('global.confirm')}}</button>
                                            <button type="button" class="btn btn-primary"  data-dismiss="modal">{{__('global.cancel')}}</button>
                                        </div>
                                    </div>
